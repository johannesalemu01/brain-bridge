  ...
  const sidebarContent = (
    <>
      ...
      <div className="flex-1 overflow-y-auto py-6 px-4 space-y-2">
        <div className="mb-6 px-4 text-xs font-semibold text-white/40 uppercase tracking-wider">
          Main Menu
        </div>
        {navItems.map((item) => {
        ...
        <div className="mt-8 px-2 space-y-3">
          ...
          <div className="rounded-2xl border border-teal-500/20 bg-teal-500/10 p-4">
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              Use Voice Learning to explain a topic, then save it to the Q&A
              board for quick revision.
            </p>
            <Link
